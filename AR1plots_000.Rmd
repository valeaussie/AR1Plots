...
PARAMETERS:  
variance of the AR(1) model $\sigma^2_\mu =$ `r sigmasq`,  
...
vector_x_dat <- read.csv("C:/Users/valea/source/repos/SIScorrections/SIScorrections/vector_X_000.dat", header = FALSE)
...
vector_z_dat <- read.csv("C:/Users/valea/source/repos/SIScorrections/SIScorrections/vector_Z_000.dat", header = FALSE)
